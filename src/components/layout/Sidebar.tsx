...
const NavSection: React.FC<NavSectionProps> = ({ title, items, activeItem, isPrimaryAccount = false }) => (
    <div>
        <div className="flex items-center px-3 py-2">
            <ChevronDown className="h-4 w-4 mr-2 text-sidebar-foreground/50" />
...
const Sidebar: React.FC = () => {
  // In a real app, this would likely come from a router or global state
  ...
  return (
    <aside className="w-64 flex-col bg-sidebar text-sidebar-foreground p-2 border-r border-sidebar-border hidden md:flex">
      <div className="p-2">
